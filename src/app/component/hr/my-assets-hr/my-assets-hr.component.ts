...
@Component({
  selector: 'app-my-assets-hr',
  templateUrl: './my-assets-hr.component.html',
  styleUrls: ['./my-assets-hr.component.css'],
  providers: [DatePipe]
})
export class MyAssetsHrComponent implements OnInit {
  // UI State
  activeTab = 'my-assets';
