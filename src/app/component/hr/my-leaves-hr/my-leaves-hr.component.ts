...
@Component({
   selector: 'app-my-leaves-hr',
  templateUrl: './my-leaves-hr.component.html',
  styleUrls: ['./my-leaves-hr.component.css'],
  providers: [DatePipe]
})

export class MyLeavesHrComponent implements OnInit {
